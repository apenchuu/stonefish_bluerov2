...
bool stonefish_ros2__msg__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("stonefish_ros2.msg._event.Event", full_classname_dest, 31) == 0);
  }
  stonefish_ros2__msg__Event * ros_message = _ros_message;
  {  // x
  ...
  {  // polarity
    ...
    ros_message->polarity = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * stonefish_ros2__msg__event__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("stonefish_ros2.msg._event");
  ...
  {  // polarity
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->polarity ? 1 : 0);
    {
